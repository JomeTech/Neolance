          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start space-x-3">
                ...
                <span className="text-gray-400">contact@neolance.com</span>
              </li>
              <li className="flex items-start space-x-3">
                <Phone size={20} className="text-neolance-cyan flex-shrink-0 mt-1" />
                <span className="text-gray-400">+1 (555) 123-4567</span>
              </li>
              <li className="flex items-start space-x-3">
                <MapPin size={20} className="text-neolance-cyan flex-shrink-0 mt-1" />
                <span className="text-gray-400">Remote team across USA, UK & Europe</span>
              </li>
            </ul>
          </div>
        </div>
