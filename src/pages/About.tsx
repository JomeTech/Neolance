      ...
      <section className="py-20 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              About{" "}
              <span className="text-neolance-cyan glow-text">Neolance</span>
            </motion.h1>
            ...
            >
              We're a team of passionate freelancers dedicated to delivering
      ...
      <section className="section-padding">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            >
              Neolance was founded with a vision to bridge the gap between
              high-quality freelance work and affordable pricing. Our team of
              professionals brings together diverse skills and experiences from
              across the globe.
            </motion.p>
            <motion.p
              className="text-gray-300 mb-6"
            ...
            >
              We understand the challenges businesses face in the rapidly
              evolving digital landscape. That's why we've assembled a team of
              experts who stay at the forefront of technology trends to deliver
            ...
            >
              Our mission is simple: to provide exceptional digital services
              that help our clients succeed in an increasingly competitive
          ...
          >
            <div className="grid grid-cols-2 gap-6">
              <div className="text-center p-4">
                <div className="text-4xl font-bold text-neolance-cyan mb-2">
                  10+
                </div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-400">
                  We view ourselves as partners in our clients' success, working
          ...
          <AnimatedCard className="glass-effect p-6" delay={0.3}>
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-400">
                  Our diverse team brings global insights and cultural awareness
                  to every project.
                </p>
              </div>
            </div>
