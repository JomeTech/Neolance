      ...
      <section className="py-20 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              Have a project in mind? Get in touch with our team and let's bring
              your ideas to life.
            </motion.p>
          </div>
        </div>
          ...
          >
            ...
            <div className="space-y-8 mb-12">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-300">contact@neolance.com</p>
              ...
              <div className="flex items-start space-x-4">
                <div className="bg-neolance-purple/20 p-3 rounded-lg">
                  <Phone className="w-6 h-6 text-neolance-cyan" />
                </div>
                <div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-300">
                    Remote team across USA, UK & Europe
                  </p>
                  <p className="text-gray-400 text-sm mt-1">
                    Working globally, available locally
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="glass-effect p-6 rounded-xl mb-8">
              ...
              <p className="text-gray-300 mb-4">
                Book a consultation call with our team to discuss your project
            ...
            <div>
              ...
              <div className="flex space-x-4">
                ...
                >
                  <svg
                    className="w-5 h-5 text-neolance-cyan"
                    fill="currentColor"
                    viewBox="0 0 24 24"
                    aria-hidden="true"
                  >
